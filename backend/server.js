...
function registerSalesRoutes(routePath, tableName) {
  app.get(`/api/sales/${routePath}`, async (req, res) => {
    if (!ensureSupabaseConfigured(res)) return;
  ...
  app.post(`/api/sales/${routePath}`, async (req, res) => {
    if (!ensureSupabaseConfigured(res)) return;
  ...
  app.put(`/api/sales/${routePath}/:id`, async (req, res) => {
    if (!ensureSupabaseConfigured(res)) return;
  ...
  app.delete(`/api/sales/${routePath}/:id`, async (req, res) => {
    if (!ensureSupabaseConfigured(res)) return;
...
// ==================== HRM AUTH + PROFILE ROUTES ====================

const defaultHrmPassword = process.env.HRM_DEFAULT_PASSWORD || 'Zollid@123';

app.post('/api/hrm/auth/login', async (req, res) => {
  if (!ensureSupabaseConfigured(res)) return;
  ...
  if (password !== defaultHrmPassword) {
...
app.get('/api/hrm/employees', async (req, res) => {
  ...
  if (email) {
    query = query.ilike('email', String(email));
  }
...
app.get('/api/hrm/attendance-records', async (req, res) => {
  if (!ensureSupabaseConfigured(res)) return;
...
app.post('/api/hrm/attendance-records/check-in', async (req, res) => {
  if (!ensureSupabaseConfigured(res)) return;
...
app.post('/api/hrm/attendance-records/check-out', async (req, res) => {
  if (!ensureSupabaseConfigured(res)) return;
...
app.get('/api/hrm/leave-requests', async (req, res) => {
  if (!ensureSupabaseConfigured(res)) return;
...
app.post('/api/hrm/leave-requests', async (req, res) => {
  if (!ensureSupabaseConfigured(res)) return;
...
app.put('/api/hrm/leave-requests/:id', async (req, res) => {
  if (!ensureSupabaseConfigured(res)) return;
...
app.get('/api/hrm/insurance-policies', async (req, res) => {
  if (!ensureSupabaseConfigured(res)) return;
...
app.get('/api/hrm/payroll-records', async (req, res) => {
  if (!ensureSupabaseConfigured(res)) return;
...
registerSalesRoutes('proposals', 'sales_proposals');
registerSalesRoutes('estimates', 'sales_estimates');
registerSalesRoutes('invoices', 'sales_invoices');
registerSalesRoutes('payments', 'sales_payments');
registerSalesRoutes('credit-notes', 'sales_credit_notes');
