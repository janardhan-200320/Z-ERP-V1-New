...
import { HRMProvider } from "@/contexts/HRMContext";
...
/**
 * Wrapper component that provides HRM context to all HRM routes
 */
function HRMRouter() {
  return (
    <HRMProvider>
...
function AppRouter() {
  return (
    <Switch>
      ...
      {/* HRM Module Routes - Wrapped with HRMProvider */}
      <Route path="/hrm/*" component={HRMRouter} />
      <Route path="/hrm" component={HRMRouter} />
