...
import { getForms, createForm, deleteForm, getFormPublicUrl, getLandingPages, createLandingPage, deleteLandingPage, getLandingPagePublicUrl } from '@/lib/form-builder-api';
import type { Form, LandingPage } from '@/lib/form-builder-api';
...
export default function FormBuilderIndex() {
  ...
  const handleCreate = async () => {
    ...
    if (error) {
      ...
      setNewTitle('');
      setNewDesc('');
      navigate(`/leads/form-builder/${data.id}`);
    }
  };
  ...
  const handleCreateLp = async () => {
    ...
    if (error) {
      ...
      setNewLpTitle('');
      setNewLpDesc('');
      navigate(`/leads/form-builder/landing-pages/${data.id}/editor`);
    }
  };
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => navigate(`/leads/form-builder/${form.id}`)}
                            >
                            ...
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => navigate(`/leads/form-builder/${form.id}/responses`)}
                            >
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => navigate(`/leads/form-builder/landing-pages/${page.id}/editor`)}
                            >
                              <Edit className="h-3.5 w-3.5 mr-1" />
                              Edit
                            </Button>
