...
import { getLandingPage, updateLandingPage, getLandingPagePublicUrl, getForms } from '@/lib/form-builder-api';
import type { LandingPageSection, LandingPageContent, Form } from '@/lib/form-builder-api';
...
export default function LandingPageEditor() {
  const [, params] = useRoute('/leads/form-builder/landing-pages/:id/editor');
      ...
      <div className="p-4 max-w-full mx-auto space-y-4">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="sm" onClick={() => navigate('/leads/form-builder')}>
