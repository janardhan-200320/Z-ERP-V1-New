...
import { getFormResponses } from '@/lib/form-builder-api';
import type { FormResponsesResult, FormResponse } from '@/lib/form-builder-api';
import { useLocation, useRoute } from 'wouter';

export default function FormResponses() {
  const [, params] = useRoute('/leads/form-builder/:id/responses');
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              size="sm"
              onClick={() => navigate(`/leads/form-builder/${formId}`)}
            >
